...
SECRET_KEY = 'django-insecure-v+gu@8re23yqsbcu@_hofwxk5=$%5(j52shusy&#qu3zg@wdj1'
...
FAMPAY_APPS = ['apps.video',]

EXTERNAL_APPS = ['django_celery_beat',]

INSTALLED_APPS = DJANGO_APPS+FAMPAY_APPS+FRAMEWORKS+EXTERNAL_APPS
